...
class SettingController: UIViewController {
    ...
    let roundIconImage =  [("Premium Calls"),("E-wallet & Free Package"),("Shop"),("Jobs"),("Invite to App"), ("Notification"), ("Chat"), ("Help")]
    
    let premiumNames = [UIImage(named: "icon1"), UIImage(named: "icon2"), UIImage(named: "icon3"), UIImage(named: "icon4"), UIImage(named: "icon5"), UIImage(named: "icon1"), UIImage(named: "icon2"), UIImage(named: "icon3")]
